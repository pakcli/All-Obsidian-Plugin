/**
 * SetupModal — confirmation + live progress for dependency installation.
 *
 * Steps:
...
export class SetupModal extends Modal {
  ...
  private settings: YTEvidenceSettings;
  private logEl: HTMLElement | null = null;
  private statusEl: HTMLElement | null = null;
  private onComplete: () => void;

  constructor(app: App, settings: YTEvidenceSettings, onComplete: () => void) {
    super(app);
