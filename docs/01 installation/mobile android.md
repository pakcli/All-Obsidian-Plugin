...
Installation guide for **Android** smartphones and tablets.
...
## 📦 Method 2: Manual Mobile File Manager

Using a mobile file manager (such as *Cx File Explorer* or *ZArchiver*):
1. Navigate to:
   ```text
